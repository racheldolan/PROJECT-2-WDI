// //if user is authenticated then we can add information into their session cookie which is useful to their session.
//
...
//       //these are variables we define for use inside views
